...
public class Escopo {
    ...
    // Uma parte fundamental na elaboração de algoritmos simlples ou complexos é determinar a localização do código em questão. Sem um domínio sobre escopo de códigos seu projeto tende a conter falhas estruturais e comprometer a proposta principal da aplicação.
    ...
    public class Conta{
        ...
        public double calcularDividaExponencial(){
            ...
            double valorMontante = 0.0; // começando a variável local de método
            for(int x=1; x<=5; x++){// x variável de escopo de fluxo de repetição
                // esta variável será reiniciada a cada execução
                double valorCalculado = valorParcela * x;
                valorMontante = valorMontante + valorCalculado;
            }
            // escopo de fluxo
            // x e valorCalculado nunca estarão disponíveis fora do método calcularDividaExponencial
